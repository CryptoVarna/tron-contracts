const { expectEvent, expectRevert } = require("@cryptovarna/tron-test-helpers");
...
contract("UUPSUpgradeable", function (accounts) {
    ...
    beforeEach(async function () {
        const { address } = await TRC1967Proxy.new(this.implInitial.address, "0x");
    ...
    it("reject upgrade to broken upgradeable implementation", async function () {
        await expectRevert(
            ...
            "TRC1967Upgrade: upgrade breaks further upgrades",
        );
    });

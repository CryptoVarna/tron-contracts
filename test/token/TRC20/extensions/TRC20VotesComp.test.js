...
const { BN, constants, expectEvent, expectRevert, time } = require('@cryptovarna/tron-test-helpers');
...
const TRC20VotesCompMock = artifacts.require('TRC20VotesCompMock');
...
contract('TRC20VotesComp', function (accounts) {
    ...
    beforeEach(async function () {
        this.token = await TRC20VotesCompMock.new(name, symbol);

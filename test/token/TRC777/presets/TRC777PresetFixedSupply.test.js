const { BN, singletons } = require("@cryptovarna/tron-test-helpers");

const { expect } = require("chai");

const TRC777PresetFixedSupply = artifacts.require("TRC777PresetFixedSupply");

contract("TRC777PresetFixedSupply", function (accounts) {
    const [registryFunder, owner, defaultOperatorA, defaultOperatorB, anyone] = accounts;

    const initialSupply = new BN("10000");
    const name = "TRC777Preset";
    const symbol = "777P";
    ...
    beforeEach(async function () {
        this.token = await TRC777PresetFixedSupply.new(name, symbol, defaultOperators, initialSupply, owner);
    });

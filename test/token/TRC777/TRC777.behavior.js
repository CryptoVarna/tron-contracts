const { BN, constants, expectEvent, expectRevert } = require("@cryptovarna/tron-test-helpers");
...
function shouldBehaveLikeTRC777DirectSendBurn(holder, recipient, data) {
    shouldBehaveLikeTRC777DirectSend(holder, recipient, data);
    shouldBehaveLikeTRC777DirectBurn(holder, data);
}

function shouldBehaveLikeTRC777OperatorSendBurn(holder, recipient, operator, data, operatorData) {
    shouldBehaveLikeTRC777OperatorSend(holder, recipient, operator, data, operatorData);
    shouldBehaveLikeTRC777OperatorBurn(holder, operator, data, operatorData);
}

function shouldBehaveLikeTRC777UnauthorizedOperatorSendBurn(holder, recipient, operator, data, operatorData) {
    shouldBehaveLikeTRC777UnauthorizedOperatorSend(holder, recipient, operator, data, operatorData);
    shouldBehaveLikeTRC777UnauthorizedOperatorBurn(holder, operator, data, operatorData);
}

function shouldBehaveLikeTRC777DirectSend(holder, recipient, data) {
...
function shouldBehaveLikeTRC777OperatorSend(holder, recipient, operator, data, operatorData) {
...
function shouldBehaveLikeTRC777UnauthorizedOperatorSend(holder, recipient, operator, data, operatorData) {
    describe("operator send", function () {
...
function shouldBehaveLikeTRC777DirectBurn(holder, data) {
...
function shouldBehaveLikeTRC777OperatorBurn(holder, operator, data, operatorData) {
...
function shouldBehaveLikeTRC777UnauthorizedOperatorBurn(holder, operator, data, operatorData) {
    describe("operator burn", function () {
        it("reverts", async function () {
...
function shouldBehaveLikeTRC777InternalMint(recipient, operator, amount, data, operatorData) {
...
function shouldBehaveLikeTRC777SendBurnMintInternalWithReceiveHook(operator, amount, data, operatorData) {
...
function shouldBehaveLikeTRC777SendBurnWithSendHook(operator, amount, data, operatorData) {
...
async function assertTokensReceivedCalled(token, txHash, operator, from, to, amount, data, operatorData, fromBalance,
    toBalance = "0") {
    await expectEvent.inTransaction(txHash, TRC777SenderRecipientMock, "TokensReceivedCalled", {
...
async function assertTokensToSendCalled(token, txHash, operator, from, to, amount, data, operatorData, fromBalance,
    toBalance = "0") {
    await expectEvent.inTransaction(txHash, TRC777SenderRecipientMock, "TokensToSendCalled", {
        operator, from, to, amount, data, operatorData, token: token.address, fromBalance, toBalance,
    });
}
...
async function sendFromHolder(token, holder, to, amount, data) {
    if ((await web3.eth.getCode(holder)).length <= "0x".length) {
        ...
        // assume holder is TRC777SenderRecipientMock contract
        return (await TRC777SenderRecipientMock.at(holder)).send(token.address, to, amount, data);
    }
}
...
async function burnFromHolder(token, holder, amount, data) {
    if ((await web3.eth.getCode(holder)).length <= "0x".length) {
        ...
        // assume holder is TRC777SenderRecipientMock contract
        return (await TRC777SenderRecipientMock.at(holder)).burn(token.address, amount, data);
    }
}

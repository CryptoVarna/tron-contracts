...
const TRC1155ReceiverMock = artifacts.require("TRC1155ReceiverMock");

function shouldBehaveLikeTRC1155([minter, firstTokenHolder, secondTokenHolder, multiTokenHolder, recipient, proxy]) {
    ...
    describe("like an TRC1155", function () {
        describe("balanceOf", function () {
            it("reverts when queried about the zero address", async function () {
                await expectRevert(
                    this.token.balanceOf(ZERO_ADDRESS, firstTokenId),
                    "TRC1155: balance query for the zero address",
                );
            });
        ...
        describe("balanceOfBatch", function () {
            it("reverts when input arrays don't match up", async function () {
                await expectRevert(
                    ...
                    "TRC1155: accounts and ids length mismatch",
                );
        ...
        describe("setApprovalForAll", function () {
            ...
            it("reverts if attempting to approve self as an operator", async function () {
                await expectRevert(
                    ...
                    "TRC1155: setting approval status for self",
                );
            });
        });
        ...
        describe("safeTransferFrom", function () {
            ...
            it("reverts when transferring to zero address", async function () {
                await expectRevert(
                    ...
                    "TRC1155: transfer to the zero address",
                );
            });
            ...
            context("when sending to a valid receiver", function () {
                beforeEach(async function () {
                    this.receiver = await TRC1155ReceiverMock.new(
                ...
                context("without data", function () {
                    ...
                    it("calls onTRC1155Received", async function () {
                        await expectEvent.inTransaction(this.transferReceipt.tx, TRC1155ReceiverMock, "Received", {
                            operator: multiTokenHolder,
                            from: multiTokenHolder,
                            id: firstTokenId,
                            value: firstAmount,
            ...
            context("to a receiver contract returning unexpected value", function () {
                ...
                it("reverts", async function () {
                    await expectRevert(
                        ...
                        "TRC1155: TRC1155Receiver rejected tokens",
                    );
                });
            });
            ...
            context("to a receiver contract that reverts", function () {
                ...
                it("reverts", async function () {
                    await expectRevert(
                        ...
                        "TRC1155ReceiverMock: reverting on receive",
                    );
                });
            });
        ...
        describe("safeBatchTransferFrom", function () {
            ...
            it("reverts when ids array length doesn't match amounts array length", async function () {
                await expectRevert(
                    ...
                    "TRC1155: ids and amounts length mismatch",
                );
            ...
            context("when sending to a valid receiver", function () {
                ...
                context("without data", function () {
                    ...
                    it("calls onTRC1155BatchReceived", async function () {
                        await expectEvent.inTransaction(this.transferReceipt.tx, TRC1155ReceiverMock, "BatchReceived", {
                            operator: multiTokenHolder,
                            from: multiTokenHolder,
                            // ids: [firstTokenId, secondTokenId],
                            // values: [firstAmount, secondAmount],
        ...
        shouldSupportInterfaces(["TRC165", "TRC1155"]);
    });
}

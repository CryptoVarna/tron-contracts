...
const TRC1155PresetMinterPauser = artifacts.require("TRC1155PresetMinterPauser");

contract("TRC1155PresetMinterPauser", function (accounts) {
    ...
    beforeEach(async function () {
        this.token = await TRC1155PresetMinterPauser.new(uri, { from: deployer });
    });

    shouldSupportInterfaces(["TRC1155", "AccessControl", "AccessControlEnumerable"]);
    ...
    describe("minting", function () {
        ...
        it("other accounts cannot mint tokens", async function () {
            await expectRevert(
                ...
                "TRC1155PresetMinterPauser: must have minter role to mint",
            );
        });
    });
    ...
    describe("pausing", function () {
        ...
        it("cannot mint while paused", async function () {
            ...
            await expectRevert(
                ...
                "TRC1155Pausable: token transfer while paused",
            );
        });
        ...
        it("other accounts cannot pause", async function () {
            await expectRevert(
                ...
                "TRC1155PresetMinterPauser: must have pauser role to pause",
            );
        });
        ...
        it("other accounts cannot unpause", async function () {
            ...
            await expectRevert(
                ...
                "TRC1155PresetMinterPauser: must have pauser role to unpause",
            );
        });
    });

...
contract("TRC1155", function (accounts) {
    const [operator, tokenHolder, tokenBatchHolder, ...otherAccounts] = accounts;

    const initialURI = "https://token-cdn-domain/{id}.json";

    beforeEach(async function () {
        this.token = await TRC1155Mock.new(initialURI);
    });

    shouldBehaveLikeTRC1155(otherAccounts);
        ...
        describe("_mint", function () {
            it("reverts with a zero destination address", async function () {
                await expectRevert(
                    ...
                    "TRC1155: mint to the zero address",
                );
            });
        ...
        describe("_burn", function () {
            it("reverts when burning the zero account's tokens", async function () {
                await expectRevert(
                    ...
                    "TRC1155: burn from the zero address",
                );
            });

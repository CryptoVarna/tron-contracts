const { BN, expectRevert } = require("@cryptovarna/tron-test-helpers");

const { expect } = require("chai");

const TRC1155PausableMock = artifacts.require("TRC1155PausableMock");

contract("TRC1155Pausable", function (accounts) {
    const [holder, operator, receiver, other] = accounts;

    const uri = "https://token.com";

    beforeEach(async function () {
        this.token = await TRC1155PausableMock.new(uri);
    });

...
contract SafeMathMock {
    ...
    function doAddFail(uint256 a, uint256 b) public returns (uint256) {
        return SafeMath.add(a, b);
    }
    ...
    function doSubFail(uint256 a, uint256 b) public returns (uint256) {
        return SafeMath.sub(a, b);
    }
    ...
    function doMulFail(uint256 a, uint256 b) public returns (uint256) {
        return SafeMath.mul(a, b);
    }
    ...
    function doDivFail(uint256 a, uint256 b) public returns (uint256) {
        return SafeMath.div(a, b);
    }
    ...
    function doModFail(uint256 a, uint256 b) public returns (uint256) {
        return SafeMath.mod(a, b);
    }

...
contract TRC777 is Context, ITRC777, ITRC20 {
    ...
    ITRC1820Registry internal constant _TRC1820_REGISTRY =
    ...
    constructor(
        ...
        // register interfaces
        _TRC1820_REGISTRY.setInterfaceImplementer(
            address(this),
            keccak256("TRC777Token"),
            address(this)
        );
        _TRC1820_REGISTRY.setInterfaceImplementer(
            address(this),
            keccak256("TRC20Token"),
            address(this)
        );
    }
        ...
        returns (bool)
    {
        require(
            recipient != address(0),
            "TRC777: transfer to the zero address"
        );
    ...
    function authorizeOperator(address operator) public virtual override {
        require(
            _msgSender() != operator,
            "TRC777: authorizing self as operator"
        );
    ...
    function operatorSend(
        ...
        require(
            ...
            "TRC777: caller is not an operator for holder"
        );
    ...
    function transferFrom(
        ...
        require(
            ...
            "TRC777: transfer amount exceeds allowance"
        );
    ...
    function _move(
        ...
        require(
            fromBalance >= amount,
            "TRC777: transfer amount exceeds balance"
        );
        unchecked {
            _balances[from] = fromBalance - amount;
        }
    ...
    function _callTokensToSend(
        ...
        address implementer = _TRC1820_REGISTRY.getInterfaceImplementer(
            from,
            _TOKENS_SENDER_INTERFACE_HASH
        );
        if (implementer != address(0)) {
            ITRC777Sender(implementer).tokensToSend(
                operator,
                from,
                to,
                amount,
    ...
    function _callTokensReceived(
        ...
        if (implementer != address(0)) {
            ITRC777Recipient(implementer).tokensReceived(
                operator,
                from,
                to,
                amount,

...
contract JustswapExchange is TRC20, ReentrancyGuard {
  ...
  |__________________________________*/
     ...
     */
    function setup(address token_addr, address factoryInstance) public {
        require(
        ...
        factory = IJustswapFactory(factoryInstance);
  ...
  |__________________________________*/
    ...
    function trxToTokenInput(
        ...
        require(
            // address(token).safeTransfer(address(recipient),tokens_bought)
    ...
    function trxToTokenOutput(
        ...
        require(
            // address(token).safeTransfer(recipient, tokens_bought)
    ...
    function tokenToTokenInput(
        ...
        uint256 tokens_bought = IJustswapExchange(exchange_addr)
            .trxToTokenTransferInput{value: wei_bought}(
            min_tokens_bought,
            deadline,
            recipient
        );
    ...
    function tokenToTokenOutput(
        ...
        uint256 trx_sold = IJustswapExchange(exchange_addr)
            .trxToTokenTransferOutput{value: trx_bought}(
            tokens_bought,
            deadline,
            recipient
        );
  ...
  |__________________________________*/
    ...
    function addLiquidity(
        ...
        if (total_liquidity > 0) {
            ...
            require(
                // address(factory) != address(0) &&
                address(token) != address(0) && msg.value >= 10_000_000,
                "INVALID_VALUE"
            );
            require(
    ...
    function removeLiquidity(
        ...
        payable(msg.sender).transfer(trx_amount);
